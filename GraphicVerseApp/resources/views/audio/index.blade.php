                ...
                <div class="results-container">
                    ...
                    <div class="sort-container">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ route('filter.audio', array_merge(request()->except('sort'), ['sort' => 'likes_asc'])) }}">Likes (Ascending)</a></li>
                            <li><a class="dropdown-item" href="{{ route('filter.audio', array_merge(request()->except('sort'), ['sort' => 'likes_desc'])) }}">Likes (Descending)</a></li>
