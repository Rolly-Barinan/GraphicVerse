...
function hideAlerts() {
    ...
    function validateForm() {
        ...
        if (!assetFiles.files.length || !assetType.value || !packageName.value || !description.value || !price.value || !categoryCheckboxes.length) {
        ...
        if (preview.files.length) {
            ...
            if (!allowedExtensions.includes(previewExtension)) {
                alert("Preview file must be a JPEG or PNG.");
                return false;
            }
        }
