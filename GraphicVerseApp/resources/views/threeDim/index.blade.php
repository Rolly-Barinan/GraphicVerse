...
<div class="container-fluid d-flex" >
    <div class="sticky-column filter_column">
        <div class="header">
            <h3>Refine by</h3>
            <a href="{{ route('filter.3d') }}" class="btn btn-link">Clear Filters</a>
        </div>
    ...
    <div class="scrollable-column packages_column">
        <!-- Your existing code for displaying packages goes here -->
            ...
            <h1 class="text-center w-100">3D ASSETS</h1>
                <div class="results-container">
                    ...
                    <div class="sort-container">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                            <li><a class="dropdown-item" href="{{ route('threeDim.index', array_merge(request()->except('sort'), ['sort' => 'name_asc'])) }}">Name (Ascending)</a></li>
                            <li><a class="dropdown-item" href="{{ route('threeDim.index', array_merge(request()->except('sort'), ['sort' => 'name_desc'])) }}">Name (Descending)</a></li>
                            <li><a class="dropdown-item" href="{{ route('threeDim.index', array_merge(request()->except('sort'), ['sort' => 'price_asc'])) }}">Price (Ascending)</a></li>
                            <li><a class="dropdown-item" href="{{ route('threeDim.index', array_merge(request()->except('sort'), ['sort' => 'price_desc'])) }}">Price (Descending)</a></li>
                            <li><a class="dropdown-item" href="{{ route('threeDim.index', array_merge(request()->except('sort'), ['sort' => 'username_asc'])) }}">UserName (Ascending)</a></li>
                            <li><a class="dropdown-item" href="{{ route('threeDim.index', array_merge(request()->except('sort'), ['sort' => 'username_desc'])) }}">UserName (Descending)</a></li>
