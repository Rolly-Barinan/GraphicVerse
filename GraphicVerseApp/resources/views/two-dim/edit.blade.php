        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('twoD.update', $model2D->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="package_name" type="text" class="form-control @error('package_name') is-invalid @enderror"
                                        name="package_name" value="{{ $model2D->twoD_name }}" autocomplete="package_name" autofocus>
                                    @error('package_name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                                        name="description" value="{{ $model2D->description }}" autocomplete="description" autofocus>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    <a href="{{ route('twoD.show', ['id' => $model2D->id]) }}" class="btn btn-primary">Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
